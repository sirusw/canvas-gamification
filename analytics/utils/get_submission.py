...
def submission_analysis():
    ...
    for java_sub_obj in java_list:
        ...
        try:
            sub_analytics = submission_analytics.objects.get(submission=submission)
        except submission_analytics.DoesNotExist:
            sub_analytics = submission_analytics.objects.create(submission_type="java", uqj=uqj, submission=submission,
                                                                question=question_obj, user_id=user_id,
    ...
    for parsons_sub_obj in parsons_list:
        ...
        try:
            ...
            sub_analytics = submission_analytics.objects.create(submission_type="parsons", uqj=uqj,
    ...
    for mcq_sub_obj in mcq_list:
        ...
        try:
            ...
            sub_analytics = submission_analytics.objects.create(submission_type="mcq", uqj=uqj, submission=submission,
                                                                question=question_obj, user_id=user_id,
                                                                first_name=first_name, last_name=last_name,
                                                                ans=ans)
